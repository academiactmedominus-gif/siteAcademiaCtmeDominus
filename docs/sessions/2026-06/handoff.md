...
- **Arquivo modificado**: [page.tsx](file:///c:/xampp/htdocs/CtmeDominus/src/app/page.tsx)
  ...
  - Adicionado suporte a posicionamento customizado (`objectPosition`) por imagem. A Imagem 3 (foto do grupo) foi ajustada para `center 30%` para enquadrar perfeitamente tanto a fila de cima quanto a de baixo.
